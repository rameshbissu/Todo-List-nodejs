...
const personalCategoryList = document.getElementsByClassName(
  "personal-category-list"
);
const shoppingCategoryList = document.getElementsByClassName(
  "shopping-category-list"
);
const othersCategoryList = document.getElementsByClassName(
...
const lisitButtomSection = document.getElementsByClassName(
  "list-buttom-section"
);
